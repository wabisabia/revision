...
- [📈 CS352 - Project Management for Computer Scientists](cs352.md)
  ...
  - [Background and Definitions](cs352/background.md)
    ...
    - [Iron Triangle](cs352/background/iron-triangle.md)
    - [Stakeholders](cs352/background/stakeholders.md)

  - [Initiation](cs352/starting.md)

    - [Pre-Initiation](cs352/starting/pre_initiation.md)
    - [Initiation](cs352/starting/initiation.md)
    - [SMART Objectives](cs352/starting/smart.md)

  - [Planning](cs352/planning.md)

    - [Scope and Time Management](cs352/planning/scope-and-time-management.md)
    - [Budgeting and Forecasting](cs352/planning/budgeting-and-forecasting.md)
    - [Why Projects Fail](cs352/planning/failure.md)
    - [KPIs](cs352/planning/kpis.md)

  - [Execution](cs352/execution.md)

    - [Waterfall](cs352/execution/waterfall.md)
    - [Lean](cs352/execution/lean.md)
    - [Agile](cs352/execution/agile.md)
    - [Kanban](cs352/execution/kanban.md)
    - [Scrum](cs352/execution/scrum.md)
    - [Scrum vs Kanban](cs352/execution/scrum-v-kanban.md)
    - [Agile Variants](cs352/execution/agile-variants.md)

  - [Monitoring and Controlling](cs352/oversight.md)

    - [RACI Matrix](cs352/oversight/raci.md)
    - [SWOT](cs352/oversight/swot.md)
    - [Risk Breakdown Structure](cs352/oversight/rbs.md)
    - [Decision Tree Analysis](cs352/oversight/decision-tree-analysis.md)
    - [Ishikawa/Fishbone Diagram](cs352/oversight/ishikawa.md)
    - [Sensitivity Analysis](cs352/oversight/sensitivity-analysis.md)
    - [Risk Matrix](cs352/oversight/risk-matrix.md)
    - [Failure Mode and Effects Analysis](cs352/oversight/fmea.md)

  - [Closing](cs352/closing.md)
